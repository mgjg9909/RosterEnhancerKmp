...
class DashboardViewModel constructor(
    ...
    private val endOfUpcomingRange = today.plusMonths(1).withDayOfMonth(today.plusMonths(1).lengthOfMonth)
    ...
    private fun loadDashboard() {
        ...
        viewModelScope.launch {
            dataStoreManager.selfMatricola.flatMapLatest { matricola ->
                ...
                println("DashboardViewModel" + ": " + "Dashboard: ERRORE nel flusso" + " - " + e.message)
                ...
                val weeksInMonth = today.lengthOfMonth / 7.0
    ...
    fun saveShiftNote(shift: Shift, text: String, extraMinutes: Int, otStart: LocalTime?, otEnd: LocalTime?) {
        viewModelScope.launch {
